...
function addUsers(userInfo) {
    let sql = "Insert into users(firstname, lastname, email, password, passwordconfirm) values ('" + userInfo.firstname + "','"+ userInfo.lastname+ "','"+ userInfo.about+ "','" + userInfo.email + "','"+ userInfo.password+ "','" + userInfo.passwordconfirm + "','" + "')";
